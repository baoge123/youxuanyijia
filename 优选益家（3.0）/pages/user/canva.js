...
Page({
   ...
   */
  data: {
    img: "../../image/icon/share_user_bg.png",
    wechat: "../../image/icon/share_user_bgrw.png",
  ...
  createNewImg: function () {
    ...
    context.setFillStyle("#323c58")
    context.fillRect(0, 0, 375, 667)
    var path = "/image/icon/share_user_bg.png";
    //将模板图片绘制到canvas,在开发工具中drawImage()函数有问题，不显示图片
    //不知道是什么原因，手机环境能正常显示
    context.drawImage(path, 0, 0, 375, 183);
    // var path1 = that.data.touxiang;
    var path1 ="../../image/icon/good.png";
    console.log(path1, "path1")
    //将模板图片绘制到canvas,在开发工具中 drawImage()函数有问题，不显示图片
