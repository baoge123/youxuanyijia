...
Page({
  ...
  onLoad: function(options) {
    var phone = wx.getStorageSync("workerPhone");
    var password = wx.getStorageSync("workerPassword");
    this.setData({
      phone: phone ? phone : '',
  ...
  btnSureSend() {
    ...
    app.getRequest(params).then((res) => {
      wx.setStorageSync("staff_id", res.data.id);
      wx.setStorageSync("shopType", res.data.status);
      wx.setStorageSync("workerPhone", phone);
      wx.setStorageSync("workerPassword", password);
      wx.showToast({
        title: '登陆成功',
      })
      setTimeout(function() {
